...
class ScalrCropTest extends AbstractScalrTest {
	...
	@Test
	void testCropWH() {
	  assertImgEquals(load("time-square-crop-wh.png"), crop(src, 320, 240));
	}

	@Test
	void testCropXYWH() {
	  assertImgEquals(load("time-square-crop-xywh.png"),
				crop(src, 100, 100, 320, 240));
	}

	@Test
	void testCropXYWHOps() {
	  assertImgEquals(load("time-square-crop-xywh-ops.png"),
